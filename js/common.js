(function($) {
	...
	Kimkra.videoview = function(data) {
		...
		poster.appendChild(_createElement("img", {
			class: "play",
			style: "background-image:url(img/img.png)",
			...
			tap: function() {
				Kimkra.router.load("index.html?m=pages&a=videoViewer&vid=id2");
			}
		}));
